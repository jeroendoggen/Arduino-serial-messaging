// SerialSender.h - Library for sending serial data messages
...
//abstract class SerialSender
class SerialSender : public SerialCommunication
{
  public:
//     void begin();
...
//       uint8_t payload;
//       uint8_t parity;
//     } outgoingMessage;             //TODO: also use this struct to send messages
